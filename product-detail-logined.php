            ...
            <div class="product-container">
                ...
                <div class="product-container">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li>
                            <a href="#!" class="breadcrumbs__link breadcrumbs__link--current">Chi tiết sản phẩm
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="product-container prod-info-container">
                    <div class="row">
                        ...
                        <div class="col-7 col-xl-12">
                            <form action="./addTocart-logined.php?id=<?php echo $row_sp["IdSanPham"]; ?>" method="POST"
                                class="form">
                                    ...
                                    <div class="row">
                                        <div class="col-5 col-xxl-6 col-xl-12">
                                            <div class="prod-prop">
                                                ...
                                                <h4 class="prod-prop__title">(4.0) 1100 Đánh giá</h4>
                                            </div>
                                            ...
                                            <div class="prod-props">
                                                ...
                                                <div class="prod-info__card">
                                                    ...
                                                    <div class="prod-info__row">
                                                        ...
                                                        <button name="btnAddToHeart"
                                                            class="like-btn prod-info__liked-btn">
                        ...
                        <div class="product-tab__contents">
                            ...
                            <div class="product-tab__content">
                                <div class="product-content">
                                    <h2 class="product-content__heading">Khách hàng của chúng tôi đã nói gì</h2>
                                    <div class="row row-cols-3 gx-lg-2 row-cols-md-1 gy-md-3">
                                        <div class="col">
                                            <!-- Review card 1 -->
                                            <div class="review-card">
                                                <div class="review-card__content">
                                                    <img src="./assets/img/product/avatar-customer.jpg" alt=""
                                                        class="review-card__avatar" />
                                                    <div class="review-card__info">
                                                        <h4 class="review-card__title">Mydu</h4>
                                                        <p class="review-card__desc">
                                                            Chỗ này bảo hành rất chi là okay la luôn, mọi người nên mua
                                                            ở đây
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="review-card__rating">
                                                    ...
                                                    <img src="./assets/icons/star-half.svg" alt=""
                                                        class="review-card__star" />
                                                    <span class="review-card__rating-title">(4.5) Đánh giá</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Review card 2 -->
                                            ...
                                            <div class="review-card">
                                                <div class="review-card__content">
                                                    <img src="./assets/img/avatar/avatar-4.jpg" alt=""
                                                        class="review-card__avatar" />
                                                    <div class="review-card__info">
                                                        <h4 class="review-card__title">Có Nguyễn</h4>
                                                        <p class="review-card__desc">
                                                ...
                                                <div class="review-card__rating">
                                                    ...
                                                    <img src="./assets/icons/star.svg" alt=""
                                                        class="review-card__star" />
                                                    <span class="review-card__rating-title">(5.0) Đánh giá</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Review card 3 -->
                                            ...
                                            <div class="review-card">
                                                <div class="review-card__content">
                                                    <img src="./assets/img/avatar/avatar-5.jpg" alt=""
                                                        class="review-card__avatar" />
                                                    <div class="review-card__info">
                                                        <h4 class="review-card__title">Đăng Quang</h4>
                                                        <p class="review-card__desc">
                                                            Thấy đồng hồ trên avatar tui không, mua trên shop này đó
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="review-card__rating">
