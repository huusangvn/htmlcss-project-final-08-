...
<body>
                                    ...
                                    <article class="address-card">
                                        ...
                                        <div class="address-card__right">
                                            <div class="address-card__ctrl">
                                                <button class="address-card__edit-btn js-toggle"
                                                    toggle-target="#add-new-address">
    ...
    <div id="delete-confirm" class="modal modal--small show d-none">
    ...
    <div id="add-new-address" class="modal show" style="--content-width: 650px">
        <div class="modal__content">
