                ...
                <div class="col">
                    <article class="product-card">
                        ...
                        <h3 class="product-card__title">
                            <a
                                href="./product-detail.php?id=<?php echo $row_sp["IdSanPham"]; ?>"><?php echo $row_sp["TenSanPham"]; ?></a>
                        </h3>
            ...
            <div class="home__row">
                ...
                <div class="filter-wrap">
                    ...
                    <div id="home-filter" class="filter hide">
                        ...
                        <form action="./search.php" class="filter__form form">
                            <div class="filter__row filter__content">
                                ...
                                <div class="filter__col">
                                    ...
                                    <div class="filter__form-group">
                                        <div class="form__tags">
                                            <button class="form__tag" name="txtTop-act__search"
                                                value="LAPTOP">LAPTOP</button>
                                            <button class="form__tag" name="txtTop-act__search"
                                                value="Iphone">Iphone</button>
                                            <button class="form__tag" name="txtTop-act__search" value="ĐỒNG HỒ">ĐỒNG
                                                HỒ</button>
                                        </div>
                                    </div>
                                </div>
