<?php
    ...
    $sql_search = "SELECT *FROM tbl_sanpham where TenSanPham like '%$nameSearch%'";
...
<body>
    ...
    <div class="container home">
        ...
        <section class="home__container">
            <div class="home__row">
                <h2 class="home__heading">Từ khóa tìm kiếm: <?php echo $nameSearch; ?></h2>
            ...
            <div class="row row-cols-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-1 g-2">
                ...
                <?php
                    ...
                    while ($row_sp = mysqli_fetch_assoc($query_search)) {?>
                <div class="col">
